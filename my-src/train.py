...
from envs import CanvasEnv, CANVAS_WIDTH, N_ACTIONS
...
def build_and_train(game="pong", run_ID=0, cuda_idx=None):
    ...
    agent = CategoricalPgAgent(
        ModelCls=MyModel,
        model_kwargs=dict(
            image_shape=(1, CANVAS_WIDTH, CANVAS_WIDTH), output_size=N_ACTIONS
        ),
...
if __name__ == "__main__":
    ...
    build_and_train(game=args.game, run_ID=args.run_ID, cuda_idx=args.cuda_idx)
